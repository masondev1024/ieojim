/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example` (hash: fe9e55c423df31d0cc28fec31baa85b8)
// Runtime types generated with workerd@1.20260907.1 2026-09-07 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	RUN_QUEUE: Queue;
	PUBLIC_WRITES?: RateLimit;
	ASSETS: Fetcher;
	APP_ENV: "staging" | "production" | "development";
	MODEL: "gemini-3.8-flash";
	DAILY_BUDGET_MICRO_USD: "2500000" | "500000";
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		APP_ENV: "staging";
		MODEL: "gemini-3.8-flash";
		DAILY_BUDGET_MICRO_USD: "2500000";
		TOTAL_BUDGET_MICRO_USD: "15000000";
		OWNER_DAILY_RUNS: "10";
		GEMINI_API_KEY: string;
		BETTER_AUTH_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "MODEL" | "DAILY_BUDGET_MICRO_USD" | "TOTAL_BUDGET_MICRO_USD" | "OWNER_DAILY_RUNS" | "GEMINI_API_KEY" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET">> {}
}
